...
def autostart():
        ...
        if setting.get('service_startup') and not xbmcvfs.exists(tempdir):
            xbmc.executebuiltin('XBMC.AlarmClock(ArtworkDownloader,XBMC.RunScript(script.artwork.downloader.mp,silent=true),00:%s:15,silent)' % setting.get('setting.service_startupdelay')) 
            ...
            while (not xbmc.abortRequested):
                ...
                if not(time.strftime('%H:%M') == service_runtime):
                    ...
                    if not xbmcvfs.exists(tempdir):
                        ...
                        xbmc.executebuiltin('XBMC.RunScript(script.artwork.downloader.mp,silent=true)')
...
if (__name__ == "__main__"):
    log("######## Artwork Downloader MP Service: Initializing........................")
